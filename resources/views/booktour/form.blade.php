						...
						<fieldset><legend>{{Lang::get('core.booktour')}}</legend>
								...
								{!! Form::hidden('bookingID', app('request')->input('bookingID') ) !!}
										...
										<div class="" id="package_part" style="display:none;">
											...
											<div class="form-group  " >
											<label for="ticketID" class=" control-label col-md-4 text-left">{{ Lang::get('core.flighttype') }} <span class="asterix"> * </span></label>
											<div class="col-md-4">
												<select name='ticketID' rows='5' id='ticketID' class='select2' disabled>
												</select>
											 </div>
											</div>
										</div>
