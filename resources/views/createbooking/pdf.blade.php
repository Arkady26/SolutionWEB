...
@if ( $car != NULL )
      ...
      <!-- <p>{{Lang::get('core.vouchertext2')}}</p> -->
			...
			<div style="float: right;">
				<h1>Signature</h1>
				<p> {{sprintf(Lang::get('core.signedby'), \App\Library\SiteHelpers::formatLookUp($row->travellerID,'travellerID','1:travellers:travellerID:nameandsurname'), date("d-m-Y", strtotime($row->signed_datetime)))}}<p>
