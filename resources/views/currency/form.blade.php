			...
			<div class="col-md-12">
				...
				{!! Form::hidden('currencyID', $row['currencyID']) !!}
						...
						required     class='form-control ' />
										...
										<div class="form-group  " >
										<label for="Symbol" class=" control-label col-md-4 text-left"> {{Lang::get('core.defaultrate')}} <span class="asterix"> * </span></label>
										<div class="col-md-6">
										  <input  type='text' name='default_rate' id='default_rate' value='{{ $row['default_rate'] }}'
						required     class='form-control ' />
										 </div>
										 <div class="col-md-2">
