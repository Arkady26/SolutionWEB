...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'grouptypes/save/'.\App\Library\SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'grouptypesFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> {{ Lang::get('core.grouptypes') }}</legend>
				{!! Form::hidden('id', $row['id']) !!}
									  <div class="form-group  " >
										<label for="Supplier Type" class=" control-label col-md-4 text-left"> {{ Lang::get('core.grouptypes') }} <span class="asterix"> * </span></label>
										<div class="col-md-6">
...
$(document).ready(function() {
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("grouptypes/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
