...
<div class="box box-primary">
	...
	<div class="box-body">
	 ...
	 <?php echo Form::open(array('url'=>'grouptypes/delete/', 'class'=>'form-horizontal' ,'id' =>'MmbTable'  ,'data-parsley-validate'=>'' )) ;?>
    ...
    <table class="table table-bordered table-striped " id="{{ $pageModule }}Table">
        <thead>
			<tr>
                ...
                <th><?php echo Lang::get('core.grouptypes') ;?></th>
			...
			<tr id="form-0" >
			  ...
			  @endif
                ...
                <tr class="editable" id="form-{{ $row->id }}">
					...
					<td><a href="javascript:void(0)" class="expandable" rel="#row-{{ $row->id }}" data-url="{{ url('grouptypes/show/'.$id) }}"><i class="fa fa-plus " ></i></a></td>
					@endif
				 <td data-values="action" data-key="<?php echo $row->id ;?>"  >
					{!! \App\Library\AjaxHelpers::buttonAction('grouptypes',$access,$id ,$setting) !!}
