...
<div class="col-md-6">
    ...
    <div class="form-group">
    <label for="ipt" class=" control-label col-md-4"> {{ Lang::get('core.usedefaultcurrency') }} <br />  </label>
<div class="col-md-6">
    <div class="checkbox">
      <input name="default_currency" type="checkbox" id="default_currency" value="1" class="minimal-red"
      @if(CNF_DEF_CURRENCY ==1) checked @endif
        />  {{ Lang::get('core.fr_enable') }}
    </div>
   </div>
  </div>
    ...
    <div class="form-group">
       <label for="ipt" class=" control-label col-md-4">{{ Lang::get('core.apicurrency') }}</label>
     <div class="col-md-6">
     <input name="cnf_api_currency" type="text" id="cnf_api_currency" placeholder="https://api.exchangeratesapi.io/latest" class="form-control input-sm" value="{{ CNF_API_CURRENCY }}" />
      </div>
     </div>
