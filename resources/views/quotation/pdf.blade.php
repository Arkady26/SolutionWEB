...
<td align="right" >{{Lang::get('core.quotation_sym')}} :  {{ $row->quotationID}}</td>
</tr>
<tr>
...
<td align="right">{{Lang::get('core.untildate')}}: {{ \App\Library\SiteHelpers::TarihFormat($row->untildate)}}</td>
</tr>
<tr>
