...
{!! Form::open(array('url'=>'tickets/save/'.\App\Library\SiteHelpers::encryptID($row['ticketID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'ticketsFormAjax')) !!}
    <div class="col-md-12">
        ...
        <div class="form-group  ">
            ...
            <div class="col-md-6">
                <select name="airlinesID"  rows="5" id="editAirlinesID" class="select2   parsley-validated" required="" tabindex="-1" aria-hidden="true">
                    @php
                        $airlineIds = $row['airlinesID'];
                    @endphp
                    @foreach($airlines as $airline)
                        <option {{ $airlineIds?($airline->airlineID==$airlineIds?'selected':''):''}} value="{{$airline->airlineID}}">{{$airline->airline}}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="form-group  ">
            <label for="Depart Date"
                   class=" control-label col-md-4 text-left">{{__('core.departuredate')}} <spanclass="asterix"> * </span></label>
            <div class="col-md-4">
        ...
        <div class="form-group  returndate" style="display: block;">
            <label for="Return Date"
                   class=" control-label col-md-4 text-left"> {{__('core.returndate')}} </label>
            <div class="col-md-4">
                <div class="input-group m-b" style="width:150px !important;">
            ...
            <div class="col-md-3">
				...
				<div class="form-group ">
            <label for="price"
                   class=" control-label col-md-4 text-left"> {{__('core.price')}} <span class="asterix"> * </span></label>
            <div class="col-md-7">
