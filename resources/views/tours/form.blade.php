...
<div class="col-md-12">
				...
				{!! Form::hidden('tourID', $row['tourID']) !!}
                    ...
                    <div class="form-group tourduration" >
                      ...
                      <div class="col-md-2">
                        <input  type='text' name='total_nights' id='total_nights' value='{{ $row['total_nights'] }}' required class='form-control ' />
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-7">
										  <textarea name='tour_description' rows='4' id='tour_description' class='form-control editor' required>{{ $row['tour_description'] }}</textarea>
										 </div>
										 <div class="col-md-1">
										 </div>
									  </div>
