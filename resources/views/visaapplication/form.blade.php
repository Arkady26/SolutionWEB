...
<div class="col-md-12">
				...
				<div class="input-group m-b" style="width:150px !important;">
					...
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
						     ...
						     class='form-control ' />
									  ...
									  <div id="tour_part" class="form-group  " >
   ...
   <script type="text/javascript">
	$(document).ready(function() {
		...
		$("#currencyID").jCombo("{!! url('visaapplication/comboselect?filter=def_currency:currencyID:currency_sym') !!}",
		...
		$("#currencyID2").jCombo("{!! url('visaapplication/comboselect?filter=def_currency:currencyID:currency_sym') !!}",
